...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Region region1 = new Region("Alsace"); region1.save();
        Region region2 = new Region("Aquitaine"); region2.save();
        Region region3 = new Region("Auvergne"); region3.save();
        Region region4 = new Region("Basse-Normandie"); region4.save();
        Region region5 = new Region("Bourgogne"); region5.save();
        Region region6 = new Region("Bretagne"); region6.save();
        Region region7 = new Region("Champagne-Ardenne"); region7.save();
        Region region8 = new Region("Corse"); region8.save();
        Region region9 = new Region("Franche-Comté"); region9.save();
        Region region10 = new Region("Haute-Normandie"); region10.save();
        Region region11 = new Region("Île-de-France"); region11.save();
        Region region12 = new Region("Languedoc-Roussillon"); region12.save();
        Region region13 = new Region("Limousin"); region13.save();
        Region region14 = new Region("Lorraine"); region14.save();
        Region region15 = new Region("Midi-Pyrénées"); region15.save();
        Region region16 = new Region("Nord-Pas-de-Calais"); region16.save();
        Region region17 = new Region("Pays de la Loire"); region17.save();
        Region region18 = new Region("Picardie"); region18.save();
        Region region19 = new Region("Poitou-Charentes"); region19.save();
        Region region20 = new Region("Provence-Alpes-Côte d\'Azur"); region20.save();
        Region region21 = new Region("Rhône-Alpes"); region21.save();
        Region region22 =  new Region("Centre"); region22.save();
